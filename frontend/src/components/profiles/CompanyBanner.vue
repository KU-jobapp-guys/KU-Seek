...
<template>
  <section class="profile rounded-xl overflow-hidden shadow-xl">
    ...
    <div
      ref="containerRef"
      class="relative bg-gradient-to-b from-blue-800/20 ring-1 ring-[#B1B1B1] ring-inset to-white px-12 py-8"
    >
      <div
        class="absolute z-20 -top-20 w-[10vw] h-[10vw] p-3 min-w-[160px] min-h-[160px] rounded-full bg-gradient-to-b from-blue-900 to-blue-500 shadow-md"
      >
        <img
          ref="profileImageRef"
