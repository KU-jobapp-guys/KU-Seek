...
const loadCompany = (id?: string) => {
  ...
  companyData.value = mockCompany.find((j) => j.id === id) || null
...
const jobsData = ref([
  {
    ...
    postTime: '3',
    description:
      "Our company is so good!!! Please apply this job I'm begging WE HAVE FREE FOOD ahhhhhhh bla bla bla yada yada something something-- Please apply this job I'm begging WE HAVE FREE FOOD ahhhhhhh bla bla bla yada yada something something ahhhhhhhhhhhhhhhh...",
    jobType: 'Full-time',
  ...
  },
  {
    ...
    postTime: '5',
    description:
      "Join our amazing backend team! We're looking for passionate developers to help build scalable systems. Great benefits and flexible working hours available.",
    jobType: 'Full-time',
  ...
  },
  {
    ...
    postTime: '7',
    description:
      'Creative designer needed to craft beautiful user experiences. Work with cross-functional teams to deliver innovative design solutions.',
    jobType: 'Part-time',
    skills: [
      'Figma',
      'Adobe XD',
  ...
  },
  {
    ...
    postTime: '10',
    description:
      'Seeking experienced DevOps engineer to manage our cloud infrastructure and deployment pipelines. Remote work available.',
    jobType: 'Full-time',
    skills: [
      'AWS',
      'Kubernetes',
  ...
  },
  {
    ...
    postTime: '15',
    description:
      'Lead product strategy and roadmap development. Work closely with engineering and design teams to deliver exceptional products.',
    jobType: 'Full-time',
...
<template>
  <div v-if="companyData" class="px-48 py-16">
    <section class="profile">
      ...
      <div
        ref="containerRef"
        class="relative bg-gradient-to-b from-[#045c3a44] ring-1 ring-[#B1B1B1] ring-inset to-white p-8"
      >
        <img
          ref="profileImageRef"
        ...
        <svg
          ...
          class="absolute right-20 lucide lucide-square-pen-icon lucide-square-pen"
        >
        ...
        >
          ...
          <button
            class="bg-white rounded-lg shadow-[0_4px_6px_rgba(0,0,0,0.25)] px-8 py-1 text-[#01432A] [text-shadow:-1px_-1px_0_#B1B1B1,1px_-1px_0_#B1B1B1,-1px_1px_0_#B1B1B1,1px_1px_0_#B1B1B1]"
          >
            see jobs
          </button>
        </div>
    ...
    <section class="data mt-8">
      <div
        class="bg-gradient-to-b from-[#72908484] to-white rounded-[20px] ring-1 ring-[#B1B1B1] ring-inset w-[100%] p-8"
      >
        ...
        <div class="p-8">
          ...
          <div v-if="activeTab === 'overview'" class="space-y-6">
            <div
              class="bg-white ring-1 ring-[#B1B1B1] ring-inset py-12 px-6 rounded-[20px] shadow-[0_4px_6px_rgba(0,0,0,0.25)]"
            >
          ...
          <div v-else-if="activeTab === 'job'" class="relative">
            <div class="space-y-4">
              ...
              >
                <div
                  v-for="(job, jobIndexInRow) in row"
                  :key="job.role + job.postTime"
                  class="flex flex-col gap-y-2 bg-white ring-1 ring-[#B1B1B1] ring-inset py-8 px-6 rounded-[20px] shadow-[0_4px_6px_rgba(0,0,0,0.25)]"
                >
                  ...
                  <div class="flex gap-1 flex-wrap">
                    <template
                      v-for="(skill, index) in getSkillsToShow(
                        job.skills,
                        getJobIndex(job, rowIndex, jobIndexInRow),
                      ).skills"
                      :key="skill"
                    >
                      <div
                    ...
                    <button
                      v-if="
                        getSkillsToShow(job.skills, getJobIndex(job, rowIndex, jobIndexInRow))
                          .hasMore
                      "
                    ...
                    <button
                      v-if="
                        expandedSkills.has(`job-${getJobIndex(job, rowIndex, jobIndexInRow)}`) &&
                        job.skills.length > 3
                      "
                      @click="toggleSkillsExpansion(getJobIndex(job, rowIndex, jobIndexInRow))"
                      class="rounded-full bg-gray-200 text-gray-600 py-1 px-3 text-xs hover:bg-gray-300 transition-colors duration-200 whitespace-nowrap"
                  ...
                  <button
                    class="mt-4 bg-[#878787] text-white font-bold rounded-xl self-end py-2 px-6 text-sm"
                  >
                    View Details
                  </button>
                </div>
